...
addDistros() {
    ...
    distro-add-atomic Fedora-25-Atomic-x86_64  /root/distro/iso/Fedora-Atomic-ostree-x86_64-26-20170723.0.iso --ksmeta="${FEDORA_KSMETA_DATA}"    --arch="x86_64" --os-version="fedora25"
}
