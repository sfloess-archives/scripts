...
addDistros() {
    ...
    distro-add        RHEL-7-x86_64            /opt/distro/iso/rhel-server-7.5-x86_64-dvd.iso                --ksmeta="${ENTERPISE_KSMETA_DATA}"
    distro-add        Fedora-28-x86_64         /opt/distro/iso/Fedora-Server-dvd-x86_64-28-1.1.iso           --ksmeta="${FEDORA_KSMETA_DATA}"
    ...
    distro-add-atomic Fedora-28-Atomic-x86_64  /opt/distro/iso/Fedora-AtomicHost-ostree-x86_64-28-20180425.0.iso --ksmeta="${FEDORA_KSMETA_DATA}"    --arch="x86_64" --os-version="fedora28"
}
...
addProfiles() {
    ...
    FEDORA_REPOS="Fedora-28-everything Fedora-28-updates"
    ...
    cobbler-exec profile add --name="Fedora-28-x86_64"        --distro="Fedora-28-x86_64"        --repos="${FEDORA_REPOS}" --kickstart="${STANDARD_KICKSTART}"
...
addHosts() {
    ...
    cobbler-exec system add --name="cloud-host-01" --hostname="cloud-host-01" --profile="RHEL-7-x86_64"   --interface="eth0" --mac-address="00:8C:FA:2D:45:05" --virt-type="kvm"   --ksmeta='autopart="--nohome" lvmDisks="sda" completionMethod="reboot"'
    cobbler-exec system add --name="cloud-host-02" --hostname="cloud-host-02" --profile="CentOS-7-x86_64" --interface="eth0" --mac-address="00:14:22:2A:AF:F8" --virt-type="xenpv" --ksmeta='lvmDisks="sda sdb" completionMethod=reboot'
    cobbler-exec system add --name="cloud-host-03" --hostname="cloud-host-03" --profile="RHEL-7-x86_64"   --interface="eth0" --mac-address="00:19:B9:1F:34:B6" --virt-type="kvm"   --ksmeta='lvmDisks="sda sdb sdc" completionMethod=reboot'
    cobbler-exec system add --name="cloud-host-04" --hostname="cloud-host-04" --profile="RHEL-7-x86_64"   --interface="eth0" --mac-address="00:21:9B:32:5F:78" --virt-type="kvm"   --ksmeta='lvmDisks="sda sdb sdc" completionMethod=reboot' 
}
...
addVms() {
    ...
    cobbler-exec system add --name="fedora-kvm" --hostname="fedora-kvm" --profile="Fedora-28-x86_64" --interface="eth0"  --mac-address="random" --virt-type="kvm" --virt-file-size="10" --virt-ram="2048" --virt-bridge="bridge0" --kickstart="${STANDARD_KICKSTART}" --netboot-enabled=1
    ...
    cobbler-exec system add --name="fedora-xen" --hostname="fedora-xen" --profile="Fedora-28-x86_64" --interface="eth0"  --mac-address="random" --virt-type="xenpv" --virt-file-size="10" --virt-ram="2048" --virt-bridge="bridge0" --ksmeta='completionMethod=poweroff' --kickstart="${STANDARD_KICKSTART}" --netboot-enabled=1
    ...
    cobbler-exec system add --name="fedora-atomic-kvm" --hostname="fedora-atomic-kvm" --profile="Fedora-28-Atomic-x86_64" --interface="eth0"  --mac-address="random" --virt-type="kvm" --virt-file-size="20" --virt-ram="4096" --virt-bridge="bridge0" --ksmeta='clearpart="none --initlabel" hostname="fedora-atomic-kvm"'
    ...
    cobbler-exec system add --name="fedora-atomic-xen" --hostname="fedora-atomic-xen" --profile="Fedora-28-Atomic-x86_64" --interface="eth0"  --mac-address="random" --virt-type="xenpv" --virt-file-size="50" --virt-ram="2048" --virt-bridge="bridge0" --ksmeta='hostname="fedora-atomic"' --netboot-enabled=1
    ...
    cobbler-exec system add --name="fedora-workstation" --hostname="fedora-workstation"  --profile="Fedora-28-x86_64"  --interface="eth0" --mac-address="52:54:00:62:d7:a8" --virt-type="kvm" --virt-file-size="50"  --virt-ram="4096" --virt-bridge="bridge0" --virt-cpus=4 --ksmeta="autopart='--nohome' packages='python,libselinux-python'" --kickstart="${STANDARD_KICKSTART}" --netboot-enabled=1

    cobbler-exec system add --name="fedora-workstation-xen" --hostname="fedora-workstation-xen"  --profile="Fedora-28-x86_64"  --interface="eth0" --mac-address="00:16:3e:4f:0c:d1" --virt-type="xen" --virt-file-size="50"  --virt-ram="3400" --virt-bridge="bridge0" --virt-cpus=4 --ksmeta="autopart='--nohome' packages='python,libselinux-python'" --kickstart="${STANDARD_KICKSTART}" --netboot-enabled=1
