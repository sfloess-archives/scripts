...
cobbler-exec system add --name="laptop" --hostname="laptop" --profile="CentOS-7-x86_64"   --interface="eth0" --mac-address="00:8c:fa:2d:45:05" --virt-type="kvm" --kickstart="${STANDARD_KICKSTART}"
